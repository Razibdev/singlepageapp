<template>
  <div class="bg-color-primary text-color-white tracking-wider">
    <header class="sticky top-0 z-50 bg-color-primary">
      <nav class="container flex justify-between items-center">
        <div class="py-5 text-color-secondary font-bold text-3xl">
          <a href="#home"> <span class="text-color-white">Light</span>Code. </a>
        </div>
        <div>
          <ul class="hidden sm:flex items-center space-x-6">
            ...
            <li>
              <a href="#pricing" class="hover:text-color-secondary ease-in duration-200">Pricing</a>
            </li>
            <li>
            ...
            <li>
              <Button
                class="bg-color-secondary px-6 py-3 rounded-md capitalize font-bold hover:opacity-80 ease-in duration-200">Free
                Trial</Button>
            </li>
          </ul>
        </div>
        <!-- Mobile design -->
        <div id="hamburger" class="sm:hidden cursor-pointer z-50">
        ...
        <div id="menu" class="hidden bg-color-primary-dark h-[100vh] absolute inset-0">
          <ul class="h-full grid place-items-center py-20">
            <li>
              <a href="#home" class="link_menu hover:text-color-secondary ease-in duration-200">Home</a>
            </li>
            <li>
              <a href="#features" class="link_menu hover:text-color-secondary ease-in duration-200">Features</a>
            </li>
            <li>
              <a href="#testimonial" class="link_menu hover:text-color-secondary ease-in duration-200">Testimonial</a>
            </li>
            <li>
              <a href="#pricing" class="link_menu hover:text-color-secondary ease-in duration-200">Pricing</a>
            </li>
            <li>
              <a href="#blog" class="link_menu hover:text-color-secondary ease-in duration-200">Blog</a>
            </li>
            <li>
              <a href="#contact" class="link_menu hover:text-color-secondary ease-in duration-200">Contact</a>
            </li>

            <li><Button class="link_menu btn">Free Trial</Button></li>
          </ul>
        </div>
      </nav>
    </header>
    <main>
      <section id="home" class="relative">
        ...
        <div class="container py-20">
          <div class="flex flex-col items-center z-20 md:flex-row">
            ...
            <div class="md:w-1/2">
              <img style="height: 400px" src="~assets/images/12119.jpg" alt="" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" class="bg-color-primary-light">
        <div class="container py-20">
          ...
          <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 lg:gap-8 px-4 sm:px-6 md:px-8">
            <!-- Card no 1 -->
            <div
              ...
              <h3 class="text-xl font-bold py-4">Expense Traking</h3>
            ...
            <!-- Card no 2 -->
            <div
              class="bg-color-primary-dark border-2 border-solid border-color-gray text-center py-20 px-5 rounded-2xl cursor-pointer hover:bg-color-primary ease-in duration-200">
              <div class="bg-color-secondary inline-block rounded-2xl py-5 px-6">
      ...
      <section id="saving-money" class="relative">
        <div class="blob1 -z-1"></div>
        ...
        <div class="container py-20 relative">
          <div class="flex flex-col justify-between md:flex-row">
            <div class="mb-12 md:w-1/2">
              <img style="height: 400px" src="~assets/images/12136.jpg" alt="" />
            </div>
            <div class="text-center md:text-left md:w-1/2 mb-12 md:ml-20">
      ...
      <section id="testimonial">
        <div class="container py-20">
          <div class="text-center m-auto mb-20 md:w-1/2">
            ...
            <h1 class="title">What Client Say About Our App After Use It</h1>
          </div>
          <!-- Review cotainer -->

          <div class="mt-8">
            <div class="flex items-center justify-center flex-wrap">
              <img class="h-20 w-20 rounded-full p-1 m-3 cursor-pointer user-pic active-pic"
                src="~assets/images/user1.jpg" alt="" @click="showReview(0)">
              <img class="h-20 w-20 rounded-full p-1 m-3 cursor-pointer user-pic " src="~assets/images/user2.jpg" alt=""
                @click="showReview(1)">
              <img class="h-20 w-20 rounded-full p-1 m-3 cursor-pointer user-pic " src="~assets/images/user3.jpg" alt=""
                @click="showReview(2)">
              <img class="h-20 w-20 rounded-full p-1 m-3 cursor-pointer user-pic " src="~assets/images/user4.jpg" alt=""
                @click="showReview(3)">
              <img class="h-20 w-20 rounded-full p-1 m-3 cursor-pointer user-pic " src="~assets/images/user5.jpg" alt=""
                @click="showReview(4)">
              <img class="h-20 w-20 rounded-full p-1 m-3 cursor-pointer user-pic " src="~assets/images/user6.jpg" alt=""
                @click="showReview(5)">
            </div>
            ...
            <div class=" grid place-items-center text-center m-auto md:w-4/5 min-h-[40vh] ">
              ...
              <div class="user-text active-text">
                <p class=" md:text-2xl mb-6 ">"This should be used to tell a story and include any testimonial you might
                  have about your product for service your clients" </p>
                <h4 class="font-bold text-color-secondary mb-1">Marking Nesus</h4>
                <p>IOS developer</p>
              </div>
      ...
      <section id="pricing" class=" bg-color-primary-light ">
        <div class="container py-20">
          <div class="text-center m-auto mb-20 md:w-1/2">
            ...
            <h1 class="title">Get In Reasonable Pricing</h1>
            <!-- Rounded Switch -->
            <div class="mt-5 flex items-center justify-center gap-4 ">
              <p>Bill Monthly</p>
              <label for="toggleBtn" class="relative inline-block w-20 h-8 rounded-full">
                <input type="checkbox" id="toggleBtn" class="peer opacity-0 w-0 h-0">
                <span
                  class="absolute top-0 left-0 right-0 bottom-0 bg-color-primary-light border border-solid border-color-gray rounded-full duration-300 before:content-[''] before:absolute before:h-6 before:w-6 before:bottom-1 before:left-1 before:rounded-full before:bg-color-white before:duration-300 peer-checked:before:translate-x-12 peer-checked:bg-color-secondary "></span>
              </label>
              <p>Bill Anually</p>
            </div>
          </div>
          ...
          <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            <!-- card 1 -->
            <div class="cart relative h-auto w-auth">
              <!-- front side -->
              <div id="card_1_front"
                class="front px-7 py-11 rounded-2xl border-2 border-solid border-color-gray w-full h-full">
                <div class="relative">
                  <p
              ...
              <!-- front back -->
              <div id="card_1_back"
                class="back rotate-y-180 px-7 py-11 rounded-2xl border-2 border-solid border-color-gray w-full h-full absolute top-0 left-0">
                <div class="relative">
                  <p
                    class="text-6xl pl-2 font-bold before:content-['$'] before:absolute before:text-sm before:top-0 before:left-0 ">
                    500<span class="text-sm font-normal tracking-widest">/ per year</span>
                  </p>
                </div>
                <div class="py-10">
                  <h3 class="text-xl font-bold pb-3">Basic</h3>
                  <p class="leading-relaxed">For Basic Who Want To Scale Business Globaly</p>
                </div>
            ...
            <div class="cart relative h-auto w-auth">
              ...
              <div id="card_2_back"
                ...
                <div class="relative">
                  <p
                    class="text-6xl pl-2 font-bold before:content-['$'] before:absolute before:text-sm before:top-0 before:left-0 ">
                    900<span class="text-sm font-normal tracking-widest">/ per year</span>
                  </p>
                </div>
                <div class="py-10">
                  <h3 class="text-xl font-bold pb-3">Standard</h3>
                  <p class="leading-relaxed">For Premium Who Want To Scale Business Globaly</p>
                </div>
            ...
            <div class="cart relative h-auto w-auth">
              ...
              <div id="card_3_back"
                ...
                <div class="relative">
                  <p
                    class="text-6xl pl-2 font-bold before:content-['$'] before:absolute before:text-sm before:top-0 before:left-0 ">
                    1250<span class="text-sm font-normal tracking-widest">/ per year</span>
                  </p>
                </div>
                <div class="py-10">
                  <h3 class="text-xl font-bold pb-3">Premium</h3>
          ...
          <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3 ">
              ...
              <div>
                <div class="lg:h-[40vh] rounded-xl scale-100 overflow-hidden ">
                  <img src="~assets/images/food1.jpg" class="lg:h-full w-full hover:scale-120 transaction duration-200 easy-in-out " alt="">
                </div>
                <div>
                  ...
                  <a href="#blog" class="text-2xl font-bold underline hover:text-color-secondary hover:no-underline">
                    Four ways to cheer yerself up on Blue Monday!
                  </a>
                  <p class="leading-relaxed my-5">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolores sunt vel neque id ducimus ...</p>
              ...
              <!-- Card no 2 -->
               <div>
                <div class="lg:h-[40vh] rounded-xl scale-100 overflow-hidden ">
                  <img src="~assets/images/food2.jpg" class="lg:h-full w-full hover:scale-120 transaction duration-200 easy-in-out " alt="">
                </div>
                <div>
                  <div class="flex items-center gap-5 py-5">
                    <p>20 August 2022</p>
...
<!-- card no 3 -->
               <div>
                <div class="lg:h-[40vh] rounded-xl scale-100 overflow-hidden ">
                  <img src="~assets/images/food3.jpg" class="lg:h-full w-full hover:scale-120 transaction duration-200 easy-in-out " alt="">
                </div>
                <div>
                  <div class="flex items-center gap-5 py-5">
                    <p>20 August 2022</p>
      ...
      <section id="download" class="bg-color-primary-light">
        <div class="container h-[80vh] grid place-items-center" >
          <div class="text-center md:w-2/3 m-auto">
            ...
            <p>Serving an impressive list of long-term money with experience and expretise in multiple industries.</p>
      ...
      <section id="contact">
        <div class="container py-20">
          <div class="text-center m-auto mb-20 md:w-1/2">
            <h4 class="font-bold text-color-secondary mb-4">Have A Question</h4>
          ...
          <form>
            <div class="w-full m-auto text-center md:w-2/3">
              <div class="text-color-primary-dark grid gap-6 mb-6 md:grid-cols-2">
                <input type="text" class="bd-gray-50 text-sm rounded-lg block w-full p-3 focus:outline-none focus: border-color-secondary" placeholder="Name">

                <input type="email" class="bd-gray-50 text-sm rounded-lg block w-full p-3 focus:outline-none focus: border-color-secondary" placeholder="Email">

                  <input type="tel" class="bd-gray-50 text-sm rounded-lg block w-full p-3 focus:outline-none focus: border-color-secondary" placeholder="Phone">
                  <input type="text" class="bd-gray-50 text-sm rounded-lg block w-full p-3 focus:outline-none focus: border-color-secondary" placeholder="Company">
              </div>
               <textarea rows="4" class="text-color-primary-dark bd-gray-50 text-sm rounded-lg block w-full p-3 focus:outline-none focus: border-color-secondary" placeholder="Message"></textarea>
        ...
        <div class="bg-color-primary-dark relative">
          <div class="container py-10">
            <div class="grid gap-10 md:grid-cols-3 pb-10">
              <div class="space-y-6">
                <h4 class="font-bold text-">About App</h4>
                <p class="leading-relaxed">This Should Be Used To Tell A Story And Include Any Testimonial You Might Have About Your Product Or Service For Your Clients</p>
                <div class="flex gap-5 items-center">
                  <p>Follow Us</p>
                  <i class="fa-brands fa-facebook-f coursor-pointer hover:text-color-secondary cursor-pointer"></i>
                  <i class="fa-brands fa-twitter coursor-pointer hover:text-color-secondary cursor-pointer"></i>
                  <i class="fa-brands fa-youtube coursor-pointer hover:text-color-secondary cursor-pointer"></i>
                  <i class="fa-brands fa-instagram coursor-pointer hover:text-color-secondary cursor-pointer"></i>
                </div>
              </div>
              <div class="flex justify-between md:justify-around">
                ...
                <div class="space-y-6">
                  ...
                  <ul class="space-y-3">
                    ...
                    <li class="underline hover:no-underline hover:text-color-secondary"><a href="#">Partners</a></li>
                    <li class="underline hover:no-underline hover:text-color-secondary"><a href="#">Career</a></li>
                    <li class="underline hover:no-underline hover:text-color-secondary"><a href="#">Reviews</a></li>
                    <li class="underline hover:no-underline hover:text-color-secondary"><a href="#">Terms & Conditions</a></li>
                    <li class="underline hover:no-underline hover:text-color-secondary"><a href="#">Help</a></li>
                  </ul>
                </div>
              ...
              <div class="space-y-6">
                <h4 class="font-bold text-">Newsletter</h4>
                <p class="leading-relaxed">Subscripe With Email And Loads Of News Will Be Sent To You</p>
                <div class="flex items-center">
                  <input type="text" class="text-color-gray bg-color-white p-2 lg:p-3 rounder-l-md focus:outline-none" placeholder="Enter Your Email">
                  <button class="bg-color-secondary px-4 py-2 lg:px-5 lg:py-3 rounded-r-md hover:opacity-90">
            ...
            <div class="flex justify-center pt-10 border-t border-color-gray">
              <p>2023 &copy; LightCode. All Rights Reserve</p>
            </div>
          </div>
        </div>
      </section>
...
function showReview(id) {
  ...
  const userPic = document.querySelectorAll(".user-pic");
  userText.forEach((item, index) => {
    userText[index].classList.remove("active-text")
    userPic[index].classList.remove("active-pic")
    if (id == index) {
      item.classList.add("active-text");
      userPic[index].classList.add("active-pic")
    }
